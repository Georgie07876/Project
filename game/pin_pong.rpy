    ...
    python:
        ...
        class PongDisplayable(renpy.Displayable):
            ...
            def __init__(self):
                ...
                self.eileen = Text(_("Щербаков"), size=36)
              ...
              # Ручка отскакивает.
               ...
               # Отскакивают от дна.
                ...
                def paddle(px, py, hotside):
                  ...
                  # Отображение весло изображения. Мы даем его площадь 800х600
...
label demo_minigame_pong:
    ...
    if winner == "eileen":
        ...
        ch "Ты победил! Поздравляю."


    menu:
        ch "Давай еще раз сыграем?"
