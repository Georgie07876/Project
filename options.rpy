...
define gui.about = _p(""" Приветствую тебя будущий абитуриент !\n
Окунись в наш маленький мир внутри лучшего университета РГЭУ (РИНХ) и узнай \n
всё о факультете компьютерных технологий и информационной безопасности \n
https://cloudnovel.net/RoyaltyFreeMusic/music/shining-stars \n
Shining Stars
by RoyaltyFreeMusic
""")
...
define config.save_directory = "KTaIS-1684602813"
