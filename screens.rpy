...
screen main_menu():
    ...
    imagemap:
        ...
        idle "gui/main_menu3.png"
        hover "gui/main_menu2.png"

        hotspot(78, 370, 322, 440) action Start()
        hotspot(78, 496, 370, 558) action ShowMenu("load")
        hotspot(78, 628, 280, 684) action ShowMenu("about")
        hotspot(78, 745, 400, 804) action ShowMenu("preferences")
        hotspot(78, 972, 230, 1026) action Quit(confirm = True)
        hotspot(1602, 978, 276, 1038) action ShowMenu("help")
